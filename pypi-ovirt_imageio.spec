...
Version  : 2.4.5
Release  : 1
URL      : https://files.pythonhosted.org/packages/57/d3/9e19c4e0fdbe69a5c7427215cfd51936a659897c0b4b13e94db82e1d0d00/ovirt-imageio-2.4.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/57/d3/9e19c4e0fdbe69a5c7427215cfd51936a659897c0b4b13e94db82e1d0d00/ovirt-imageio-2.4.5.tar.gz
...
%prep
%setup -q -n ovirt-imageio-2.4.5
cd %{_builddir}/ovirt-imageio-2.4.5
pushd ..
cp -a ovirt-imageio-2.4.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655858876
...
cp %{_builddir}/ovirt-imageio-2.4.5/COPYING %{buildroot}/usr/share/package-licenses/pypi-ovirt_imageio/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
