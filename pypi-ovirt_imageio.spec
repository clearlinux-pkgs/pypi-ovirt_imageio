...
Source0  : https://files.pythonhosted.org/packages/9d/90/4f848bd7b3300f1ca9ccf9e432aefcdf4fc18aade374952ca276bcd276b0/ovirt-imageio-2.4.9.tar.gz
...
%prep
%setup -q -n ovirt-imageio-2.4.9
cd %{_builddir}/ovirt-imageio-2.4.9
pushd ..
cp -a ovirt-imageio-2.4.9 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677860664
...
cp %{_builddir}/ovirt-imageio-%{version}/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/pypi-ovirt_imageio/3cb34cfc72e87654683f2894299adf912d14b284 || :
